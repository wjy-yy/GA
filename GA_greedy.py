...
def drawPic(dots):
    ...
    plt.savefig('Greedy Gra ' + 'pc=' + str(pc) + ' pm=' + str(pm) + ' dis=' + str(loss[-1]) + '.pdf', dpi=600, format='pdf')
    plt.show()
...
if __name__ == '__main__':
    ...
    plt.savefig('Greedy Dis '+'pc='+str(pc)+' pm='+str(pm)+' dis='+str(loss[-1])+'.pdf', dpi=600, format='pdf')
    plt.show()
